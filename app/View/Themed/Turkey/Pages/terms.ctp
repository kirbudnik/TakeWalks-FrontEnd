<div id="root">
	<article id="featured" class="transfers-hero contact-us-hero" style="background: url('theme/Turkey/img/terms_banner.jpg')">
	    <header>
	        <h2>Terms &amp; Conditions</h2>
		<p>Terms & Conditions for<br />all Walks of Turkey services.</p>
	    </header>
	</article>
	...
	<section id="content">
		<div class="terms-content">
            ...
            <p>All purchases made through this website, or over the phone through customer service, are subject to the following Terms & Conditions. In any and all bookings, the person making the booking shall be deemed to have accepted these conditions on behalf of the guest(s) named in the booking. No variation to these Terms & Conditions shall be of any effect unless made in writing by and with the authority of the company.</p>

            <h4>Payments</h4>
            <p>WalksofTurkey.com is able to accept the following payment methods: Mastercard, Visa, American Express, Discover, Paypal.</p>
            <p>The company requires full payment in advance of tour/service in order to secure your reservation. Your payment will be processed by Walks LLC (A Delaware Limited Liability Company), the bookings and payment processor for  WalksofTurkey.com. Your payment will be noted on your card as: WALKS ITALY *TRAVEL SVC / WALKS NYC *TRAVEL SVC / WALKS LLC</p>
            <p>All tours in Turkey are fulfilled and provided by our local tour operator,  Walks LLC (Texas subsidiary). The local operator must maintain licensing and full-qualified insurance, and is responsible for all on the ground logistics and operations.</p>
            ...
            <h4>Full Upfront Payment of Services</h4>
            ...
            <h4>Currency</h4>
            <p>
            Tours listed on this site are displayed and priced in local currency, unless otherwise noted at the top of the page, on the page, or as selected <span style="font-weight: bold !important; font-style: italic !important;">by the user</span>. All bookings are processed in $ (US Dollars), unless otherwise requested <span style="font-weight: bold !important; font-style: italic !important;">by a guest on page</span>. Guests accept any and all fees associated with booking tours using credit card. Licensed booking software sets all exchange rates internally, and customer service agents have no control over any rates displayed on page. Guests should be take note that any live rates listed on 3rd party sites, such as those set by <a href="http://xe.com/" rel="noreferrer" style="text-decoration: underline;" target="_blank">xe.com</a> or <a href="http://fxstreet.com/" style="text-decoration: underline;" rel="noreferrer" target="_blank">fxstreet.com</a>, are meant only as Interbank rates for transactions over $1M, and are not to be understood as a general consumer rate. If you are interested in learning more about exchanges, currencies, or payment options, please contact the company in advance of booking.
            </p>
            <h4>Delays on Group Tours / Private Tours / Private Transfer Services</h4>
<p>Upon booking of a service, you will receive a confirmation email that details meeting location and specific meeting time. Guests are asked to arrive to the meeting point 15 minutes prior to the start of the tour. Give yourself ample time to reach meeting points. If you or your travel companions are running late or need assistance in finding the meeting point, please call our office at the number provided in your confirmation email, and we will do our best to assist you, however it is your ultimate responsibility to reach a meeting point on time. The operator is not responsible for failure to arrive at a tour meeting point on time. Please see the no show/late arrival clause on the <a href="/cancellation">cancellation policy</a>. </p>
            <h4>Cancellations</h4>
	    <p>Cancelling or amending a booking with WalksofTurkey.com can result in cancellation/amendment fees being applied by WalksofTurkey.com, as outlined at the following link (<a href="/cancellation">https://www.walksofturkey.com/cancellation</a>).</p>
            <p>
            Any cancellation/amendment must be communicated via e-mail to:
            <br/>info@walksofturkey.com
            <br/>Or via telephone:
            <br/>1-866-671-1430
            </p>
            ...
            <h4>Containment of Entire Policy</h4>
<p>This terms and conditions policy is an independent document and supersedes any and all other agreements, either oral or in writing, between the parties hereto. Please see the supplement documentation regarding <a href="/cancellation">cancellation and amendment policies</a>. </p>
        </div>
		<div class="contact-us-intro">
			There is a good chance we’ve answered your question on our FAQ page, but if not, the best way to reach us for non-urgent matters us is by email at info@walksofturkey.com. Our team will try to get back to you within 24 hours with a full response. <br><br>
		...
		<section class="feeling-social">
			...
			<div class="social-text">Feel free to Tweet us <span class="red">@walksofturkey</span> write to us on <span class="red">Facebook</span> or <span class="red">Google+</span> or catch us on <span class="red">GTalk</span> as walksofturkey.</div>

            <div class="social-icons">
                <a href="https://www.facebook.com/walksofturkey"><i class="fa fa-facebook"></i></a>
                <a href="https://plus.google.com/u/0/105841538390894538446"><i class="fa fa-google-plus"></i></a>
                <a href="https://twitter.com/walksofturkey"><i class="fa fa-twitter"></i></a>
                <!--				<a href="#"><img src="/img/social/instagram.png" alt=""></a>-->
                <!--				<a href="#"><i class="fa fa-youtube"></i></a>-->
                <!--				<a href="#"><img src="/img/social/vimeo.png" alt=""></a>-->
