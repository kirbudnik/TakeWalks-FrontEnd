...
<p id="title"><i class="fa fa-shield"></i> Your information is secured using SSL encryption software under PCI compliance</p>
<section id="content" class="columns-c payment-form">
    <aside style="margin: 80px 20px 0 0;">
        <div class="cart-a">
            <div id="currencyPicker">
                <h3>Payment currency</h3>
                <?php if(ExchangeRate::getCurrency() == 'TRY') ExchangeRate::setCurrency('USD'); ?>
    ...
    <form method="post" class="form-c" novalidate id="travellerInfo" >
        ...
        <fieldset>
            ...
            <div style="margin-left: 2em;">
                <p>
                    Who needs more stuff? Give the gift of an unforgettable experience with a Walks of Turkey Gift Card, available to be purchased in one of five currencies. After purchase we will email you a copy of your gift card, with a gift card code to forward to your friend or loved one. The gift card is redeemable online by applying your gift code in our add promo-code section of our check-out page before entering your credit card details. Your gift code can be used on a single purchase or for multiple purchases on any of our tours in Turkey and is valid for 5 years after purchase. Please note exchange fees will apply if final reservation is made in a different currency from gift card.            </p>
                <p>
                    If you don't see your desired gift card value listed, email our team at <a href="mailto:info@walksofturkey.com">info@walksofturkey.com</a>.
                </p>
            </div>
            <h3>Traveller information</h3>
            <p>
                <span class="fname">
                    <label for="fca">First name</label>
                    <input type="text" id="fca" name="first_name" value="<?php if(isset($_POST['first_name'])) echo $_POST['first_name'] ?>" required>
                </span>
                <span class="lname">
                    <label for="fcb">Last name</label>
                    <input type="text" id="fcb" name="last_name" value="<?php if(isset($_POST['last_name'])) echo $_POST['email'] ?>" required>
                </span>
            </p>
            <p class="thirds">
                <span>
                ...
                <span>
                    <label for="fccc">Confirm Email</label>
            ...
            <p>
                <label for="fce">Street address</label>
                <input type="text" id="fce" name="street_address" value="<?php if(isset($_POST['city'])) echo $_POST['street_address'] ?>" maxlength="30" required>
            </p>
            <p>
                <label for="fci" class="hidden">Country</label>
                <select id="fci" name="country" required class="noDefaultSelect2" data-placeholder="Country">
                    <option></option>
...
<!--                    <label for="fcg">State / County</label>-->
            ...
            <p class="b">
							<span class="a">
								<label for="fck">Credit card number</label>
								<input type="text" id="fck" name="ccNo" maxlength="16" required>
							</span>
                <span>
								<label for="fcl" class="hidden">Card type</label>
								<select id="fcl" name="ccType" required data-placeholder="Card Type">
                                    <option></option>
            ...
            <p class="c">
                    <span class="b">
                        ...
                        <span>
                            ...
                            <select id="fcn" name="ccYear" required data-placeholder="YYYY">
                                <option></option>
                ...
                <span class="c">
                        ...
                        <span>
                            <label for="fco" class="hidden">CVV</label>
                ...
                <span class="d ccName">
                        ...
                        <span>
                            <label for="fcp">First</label>
                            <input type="text" id="fcp" name="ccFirstName" value="<?php if(isset($_POST['ccFirstName'])) echo $_POST['ccFirstName'] ?>" maxlength="15" required>
                        </span>
                        <span>
                            <label for="fcq">Last</label>
                            <input type="text" id="fcq" name="ccLastName" value="<?php if(isset($_POST['ccLastName'])) echo $_POST['ccLastName'] ?>" maxlength="15" required>
                        </span>
                    </span>
            </p>
            <div class="custom-checkboxes nts check-a">
                <input type="checkbox" id="conditions" name="conditions">
                <label for="conditions">Yes, I have read and I agree to the <a href="./terms">Booking Conditions</a>.</label>
            ...
            <p class="scheme-c"><button type="submit"><i class="fa fa-check-square-o"></i> Submit</button></p>
        </fieldset>
    </form>
