...
<div class="content wrap">
    ...
    <main>
        ...
        <div class="gift-card" style="text-align:center; padding: 20px 100px; margin: 0 50px 30px 20px; border: 2px dotted #fff; border-radius: 5px; display:inline-block; background: #a08f56">
            ...
            <div class="amount" style="font-size: 38px;color: #fff;text-shadow: 0 0 0px #888;"><?= ExchangeRate::format($gift_card['amount']) ?></div>
            <div class="code" style="color: #611906;font-size: 16px; margin-top: 10px; font-weight: bold;">Code: <?= $gift_card['code'] ?></div>
        </div>


        <p style="padding: 0 10px;max-width: 700px;font-size: 15px;line-height: 25px;">
            Thanks for giving the gift of walks! In the next few minutes you will receive an email from us with a gift card inside. Whenever you're ready, forward this to the lucky recipient. They'll be able to claim their gift by applying the gift code (which is case and space sensitive) in the add promo-code section of our check-out page before entering their credit card details. The gift code can be used on a single purchase or for multiple purchases on any of our tours in Italy and is valid for 5 years after purchase. Please note exchange fees will apply if final reservation is made in a different currency from gift card.
        </p>

        <h3 class="large">Buyer Information</h3>
        <table>
            <tr>
