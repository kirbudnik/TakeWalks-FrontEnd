...
<section id="content" class="columns-c payment-form" data-full-price-euro="<?php echo $full_price ?>" data-full-price-usd="<?php echo $full_price_usd ?>">
    ...
    <aside>
        <div class="cart-a">
            ...
            <article data-euro-price="0" data-usd-price="0" class="gift-card-cart-item">
                <h3>Gift Card</h3>
                <p>Amount</p>
            ...
            <p style="font-weight: bold">
                Total
                <span>
                    <span class="full-euro-price fullPrice">0.00</span> <br/>
    ...
    <form method="post" class="form-c" novalidate id="travellerInfo">
        ...
        <fieldset>
            ...
            <p>
                Who needs more stuff? Give the gift of an unforgettable experience with a Walks of Italy Gift Card, available to be purchased in one of five currencies. After purchase we will email you a copy of your gift card, with a gift card code to forward to your friend or loved one. The gift card is redeemable online by applying your gift code in our add promo-code section of our check-out page before entering your credit card details. Your gift code can be used on a single purchase or for multiple purchases on any of our tours in Italy and is valid for 5 years after purchase. Please note exchange fees will apply if final reservation is made in a different currency from gift card.            </p>
            <p>
                If you don't see your desired gift card value listed, email our team at <a href="mailto:info@walksofitaly.com">info@walksofitaly.com</a>.
            </p>
            ...
            <p class="thirds">
                ...
                <span>
                    ...
                    <input type="text" id="fcd" name="phone_number" value="<?php if(isset($_POST['phone_number'])) echo $_POST['phone_number'] ?>"  maxlength="14" required>
                </span>
            </p>
            <p>
...
<!--                    <label for="fcg">State / County</label>-->
            ...
            <p class="scheme-c"><button type="submit"><i class="fa fa-check-square-o"></i> Submit booking</button></p>
        </fieldset>
    </form>
</section>