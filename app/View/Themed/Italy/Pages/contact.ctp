        ...
        <div class="contact-details">
            <div>
                ...
                <div class="detail-content">
                    ...
                    from 7:30 a.m. to 5:00 p.m. (CDT)<br>
                    and on Saturday and Sunday <br>
                    from 7:30 a.m. to 4:00 p.m. (CDT)<br>
                    <br>
                    <span>From the UK:</span><br>
                    44 845 591 6256<br>
                </div>
            </div>
            ...
            <div>
                <h3 class="header-a">WITHIN PARIS</h3>
                <div class="detail-content">
                    <span>From Paris:</span> +33-176-36-0101<br>
                    Our Paris office hours are<br>
                    Monday through Friday<br>
                    from 8:15 a.m. to 6:30 p.m.<br>
                    and on Saturdays and Sundays<br>
                    from 8:15 a.m. to 3:30 p.m., Central European Time,<br>
                    Paris local time (GMT+1).<br>
                </div>
            </div>
