...
<div class="content wrap">
    <aside>
        <div id="currencyPicker">
            <h3 class="large">Payment currency</h3>
        ...
        <br>
        <articleq data-euro-price="0" data-usd-price="0" class="gift-card-cart-item">
            <h3>Gift Card</h3>
            <p>Amount</p>
            <select class="amounts" name="amount" style="width: 100%">
        ...
        <ul class="ticketsSummary total">
            <li class="large">
                <strong>Total</strong>
                <span class="full-euro-price fullPrice"></span>
            </li>
        </ul>
    ...
    <main class="serif">
        ...
        <h1 class="larger">Purchase Gift Card</h1>

        <div style="margin-left: 2em;">
            <p>
                Who needs more stuff? Give the gift of an unforgettable experience with a Walks of New York Gift Card, available to be purchased in one of five currencies. After purchase we will email you a copy of your gift card, with a gift card code to forward to your friend or loved one. The gift card is redeemable online by applying your gift code in our add promo-code section of our check-out page before entering your credit card details. Your gift code can be used on a single purchase or for multiple purchases on any of our tours in New York and is valid for 5 years after purchase. Please note exchange fees will apply if final reservation is made in a different currency from gift card.            </p>
            <p>
                If you don't see your desired gift card value listed, email our team at <a href="mailto:info@walksofnewyork.com">info@walksofnewyork.com</a>.
            </p>
        </div>

        <p class="security small">
            Your information is secured using SSL encryption software under PCI compliance.
        </p>

        <form id="travellerInfo" method="post" novalidate >
            ...
            <fieldset>
                ...
                <label class="lname">
                    Last Name
                    <input type="text" name="last_name" value="<?php if(isset($_POST['last_name'])) echo $_POST['last_name'] ?>" required>
                </label>
                <label class="email_">
                    Email Address
                    <input type="email" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email'] ?>" maxlength="50" required>
                </label>
                <label class="email_">
                    Confirm Email Address
                    <input type="email" name="confirm_email" value="<?php if(isset($_POST['confirm_email'])) echo $_POST['confirm_email'] ?>" maxlength="50" required>
                </label>
                <label class="phone">
                    Phone Number
                    <input type="text" name="phone_number" value="<?php if(isset($_POST['phone_number'])) echo $_POST['phone_number'] ?>" required maxlength="14" placeholder="">
                </label>
                <label class="audienceReward">
                    Audience Reward Number (optional)
                    <input type="text" name="audience_reward" value="<?php if(isset($_POST['audience_reward'])) echo $_POST['audience_reward'] ?>">
                </label>
                <label class="address">
                    Street Address
                    <input type="text" name="street_address" value="<?php if(isset($_POST['street_address'])) echo $_POST['street_address'] ?>" maxlength="30" required>
                </label>
                <label class="country">
                    Country<br />
                ...
                <label class="zip">
                    Zipcode
                    <input type="text" name="zip" value="<?php if(isset($_POST['zip'])) echo $_POST['zip'] ?>" maxlength="10" required>
                </label>
                <label class="city">
                    City
                    <input type="text" name="city" value="<?php if(isset($_POST['city'])) echo $_POST['city'] ?>" maxlength="20" required>
                </label>
                <label class="state">
                    <q id="state_label">State</q>
                    <input id="state_text" type="text" value="<?php if(isset($_POST['state'])) echo $_POST['state'] ?>" <?php if(isset($_POST['country']) && !in_array($_POST['country'], ['US', 'CA', 'GB']) )  {echo ' name="state" ';} else {echo ' name="state_textaa" style="display:none;" ';}?> >
            ...
            <fieldset>
                ...
                <label class="ccNo">
                    Credit card number
                    <input type="text" name="ccNo" value="<?php if(isset($_POST['ccNo'])) echo $_POST['ccNo'] ?>" maxlength="16" required>
                </label>
                <label class="ccType">
                    Card Type<br/>
                ...
                <label class="ccCVV">
                    CVV
                    <input type="text" name="ccCCV" value="<?php if(isset($_POST['ccCCV'])) echo $_POST['ccCCV'] ?>" required maxlength="4">
                </label>
                <label class="ccName">
                    Name on the card<br/>
                    <input type="text" name="ccFirstName" value="<?php if(isset($_POST['ccFirstName'])) echo $_POST['ccFirstName'] ?>" style="width: 47%"  maxlength="15" required>
                    <input type="text" name="ccLastName" value="<?php if(isset($_POST['ccLastName'])) echo $_POST['ccLastName'] ?>" style="width: 47%"  maxlength="15" required>
                </label>
            </fieldset>
            <!--            --><?php //else: ?>
            ...
            <label class="terms">
                ...
                <span>Yes, I have read and I agree to the <a href="/terms">Booking Conditions</a></span>
                <span id="conditionError" style="color: red"></span>
            </label>
            <input type="hidden" name="giftcard">
            <div id="recaptcha" class="g-recaptcha" data-sitekey="6LckYiQUAAAAACPuYPokvv54y8LeTP7qWjd24BlI" data-callback="reCaptchaCallback" data-size="invisible" ></div>
            <input class="large pink button" id="submit_booking" type="submit" value="Submit">
        </form>
...
<script type="template" class="cartTour">
    <article class="tour">
        <a
                ...
                href="/pages/remove_from_cart/<%-position %>"
                class="close" >✕</a>
        ...
        <% } %>
        <p class="timeslot"><%- dateTime %></p>

        <ul class="ticketsSummary">
            <% for(var type in tickets){ %>
            <li>
                <strong><%- tickets[type].amount %></strong> <%- type %>
                <% if(tickets[type].formattedPrice != 'Free'){ %>
            ...
            <% if(discount > 0 || promo_discount_fixed > 0){ %>
            <li style="text-decoration: line-through"><strong>Original price</strong> <span style="text-decoration: line-through"><%= originalPrice %></span></li>
            <% } %>
            <% if(discount > 0 || promo_discount_fixed > 0){ %>
            <li><strong>Discount</strong> <span>- <%= discountAmount %></span></li>
            <% } %>
