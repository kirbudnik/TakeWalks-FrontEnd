...
<header id="top-fixed" class="top-detail-nav">
    <div class="event-title">
        <div class="container">
            <h1 style="float: left;width: 40px;"><a href="/">Walks of New York</a></h1>
            <a href="#book" class="book-tour-anchor">Book Tour</a>
            <a href="/new-york-tours" style="float: right;width: 160px;"><h5>View Tours</h5></a>
            <h5><?php echo $event['name_short'] ?></h5>
        </div>
    </div>
...
<div itemscope itemtype="http://schema.org/Product" id="content-detail">
    ...
    <nav id="breadcrumbs">
        ...
        <ol>
            ...
            <li><?php echo $event['name_short'] ?></li>
        </ol>
        <p>
            <span itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="price-a <?php echo $event['group_private'] != 'Private' ? 'group_price' : 'private_price' ?>">
                ...
                <b itemprop="price" content="<?php echo $adultPrice ?>">
            ...
            <span class="rating-a white  <?php echo isset($ratings[$event['id']]) ? $ratings[$event['id']]['letterClass'] : ''?>" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" style="<?php echo !isset($ratings[$event['id']]) ? 'display:none;' : ''?>">
        ...
        <div class="columns-a no-match-height">
            <article>
                ...
                <section id="tab-target-description" class="tab-target description-section">
                    ...
                    <section class="description serif">
                        <?php foreach(explode("\n", $event['description_long']) as $n => $line) : ?>
                            <?php //if(trim($line) === '') continue; ?>
                            <?php if($n == 0) : $splitLine = explode('.', $line, 2); $first = $splitLine[0]; $line = isset($splitLine[1]) ? $splitLine[1] : ''; ?>
                ...
                <div class="double-a a activity-info-below-slider">
                    <div>
                    ...
                    <div class="review-slider">
                        ...
                        foreach ($reviews as $review) : ?>
                            ...
                            if ($stars == 5 && $length_comment < 300 && $length_comment > 0) {
                                ...
                                ?>
                                <div class="review">
                                    <div class="review-body" style="height: 80px; min-height: 80px; overflow-y: hidden;">
                                        <?php echo ($review['feedback_text']) ? : '<i>(No comment)</i>'; ?></div>
            ...
            <aside>
                ...
                <div class="calendar-a">
                    <form class="book" action="/add_to_cart" method="post" onsubmit="return ecAddToCart();">
                        ...
                        <ol>
                            ...
                            <li><a class="summary">
                                ...
                                <fieldset class="people">
                                    ...
                                    <!-- 4 - Students -->
                                    <input type="hidden" name="students" id="students" value="0">
                        ...
                        <fieldset class="submit" style="display: none;">
