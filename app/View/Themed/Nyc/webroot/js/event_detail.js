...
Tour = {
    ...
    BookingPanel : {
        ...
        showPrice : function(guests, price) {
            ...
            this.$el.find('.submit p.summary').html(guests + ' ' + guestText + ' for <span>' + formatCurrency(price, initValues.currency.type) + '</span>');
        },
        ...
        TimePicker : {
            ...
            _selectTime : function(e) {
                ...
                $('.book .private-details').css('display', $('.book .selected').hasClass('private') ? 'block' : 'none');
            }
        },
