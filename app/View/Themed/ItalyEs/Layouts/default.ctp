...
<head>
    ...
    <!-- Tinos Font Family -->
    <link href='https://fonts.googleapis.com/css?family=Tinos:400,700,400italic' rel='stylesheet' type='text/css'>
    <?php if (isset($css)) {
        foreach ($css as $filename) { ?>
            <link rel="stylesheet" href="/theme/ItalyEs/css/<?php echo $filename ?>.css?v=<?php echo $version ?>">
        <?php }
    } ?>
    ...
    <?php
    $ecTheme = 'ItalyEs';
    $devGA ='UA-23373029-13';
    echo $this->element('google_analytics', array(
        'ecTheme' => $ecTheme,
        'analyticsAccount' => (Configure::read('debug') == 0) ? 'UA-23373029-9' : $devGA,
