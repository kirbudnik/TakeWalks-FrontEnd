<img src="https://images.walks.org/logos/ops/nyc.png" height="80px" width="160px">
...
<p>Thanks for choosing to take walks with us – we're excited to be part of your adventure! If you have any questions, please don't hesitate to contact us by phone at 1-888-683-8671 or by email at <a href="mailto:info@walksofnewyork.com">info@walksofnewyork.com</a>.</p>

<p>Please have this information on hand and bring all of it with you on the day of your visit.</p>

<p>New York Toll Free Number: 1-888-683-8671 / USA Tel:  (001) 917-475-4670 </p> 

<h3>Know Before You Go:</h3>
<ul>

<li><strong>Weather</strong> - All Walks of New York services will run rain or shine, so please make sure to dress appropriately.</li>

<li><strong>Students</strong> – If you booked a student ticket you must bring a valid photo I.D with your date of birth.</li>


<li><strong>Cancellations & Amendments</strong> - Refunds will not be provided for group tours that are cancelled within 72 hours of the scheduled start time, or for private tours that are cancelled within 7 days of the scheduled start time. Please contact us as soon as possible if you need to request a change to one of your booked services. All amendments must be approved by a Walks of New York representative first and are subject to availability and applicable fees. Please click the following link for more information: [<a href="https://www.walksofnewyork.com/cancellation">https://www.walksofnewyork.com/cancellation</a>].</li>
...
/*
        if ($BookingsDetail_loop['BookingsDetail']['charged_usd_amount']){
            echo '$'.number_format($BookingsDetail_loop['BookingsDetail']['charged_local_amount'], 2, '.', ',').'';
        }

        if ($BookingsDetail_loop['BookingsDetail']['charged_local_amount'] > $BookingsDetail_loop['BookingsDetail']['charged_usd_amount']){
            echo '<br /><strong>Discount: </strong>';
            echo '- $'. number_format($BookingsDetail_loop['BookingsDetail']['charged_local_amount'] - $BookingsDetail_loop['BookingsDetail']['charged_usd_amount'], 2, '.', ',');
        }
*/
        echo '<br />';
        ...
        echo '<td width="280" valign="top"><a href="http://images.walks.org/nyc/meetingpoint/'.$BookingsDetail_loop['Event']['id'].'L.jpg"><img src="http://images.walks.org/nyc/meetingpoint/'.$BookingsDetail_loop['Event']['id'].'L.jpg" width="280" height="320"></a></td>';
        echo '</tr>';
...
<p>
    <strong>The Walks of New York Team</strong><br />
    <em>Experience New York. Take Walks.</em><br />
    <a href="http://www.walksofnewyork.com">www.walksofnewyork.com</a>
</p>
