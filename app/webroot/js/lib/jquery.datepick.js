...
function Datepicker() {
	this._defaults = {
		...
		showSpeed: 100, // Duration of display/closure
		...
		useMouseWheel: false, // True to use mousewheel if available, false to never use it
	...
	this.regional[''] = { // US/English
		...
		prevText: '<img src="/img/arrow-left-black.png" alt="Previous">', // Text for the previous month command
		prevStatus: 'Show the previous month', // Status text for the previous month command
		prevJumpText: '&lt;&lt;', // Text for the previous year command
		prevJumpStatus: 'Show the previous year', // Status text for the previous year command
		nextText: '<img src="/img/arrow-right-black.png" alt="Previous">', // Text for the next month command
