 ...
 */
	public static function write($key, $value, $config = 'default') {
		...
		if ($success === false && $value !== '') {
			...
			CakeLog::write('debug', "Cache - write error ".print_r($key, true));

			$strlenvalue = strlen(serialize($value));

			CakeLog::write('debug', "Cache - write error - strlen value ".$strlenvalue);

		//	CakeLog::write('debug', "Cache - value ".print_r($value, true));
